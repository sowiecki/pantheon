...
| spotify              | [See here](../docs/spotify.md) for more information  | No        |         |
| - cliendId           | [See here](../docs/spotify.md) for more information  | Yes       |         |
| - clientSecret       | [See here](../docs/spotify.md) for more information  | Yes       |         |
| - blacklistedPermissions | Spotify permissions to deny Pantheon             | No        |         |
| - display            | [See here](../docs/spotify.md) for more information  | No        |         |
| - browser            | [See here](../docs/spotify.md) for more information  | No        |         |
